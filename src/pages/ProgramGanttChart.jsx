...
const ProgramGanttChart = () => {
    ...
    useEffect(() => {
        ...
        // Initial scroll to show current-1 to current+11 months
        if (scrollContainerRef.current) {
            scrollContainerRef.current.scrollLeft = 3700; // 37 months * 100px
        }
    }, []);
    ...
    return (
        <div className="w-full">
            ...
            <div className="relative flex w-full">
                ...
                >
                    <div style={{ height: 40, padding: '8px', fontWeight: 600 }}>Projects</div>
